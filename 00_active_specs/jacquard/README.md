...
- `planner-component.md` - Planner 组件设计
- `scheduler-component.md` - Scheduler 组件设计
- `preset-system.md` - 预设与编排系统设计 (含能力系统)
- `capability-system-spec.md` - 能力系统详细规范
- `skein-and-weaving.md` - Skein 数据结构与编织算法
- `plugin-architecture.md` - 插件架构规范
...
10. **[Schema Injector Plugin](schema-injector.md)**:
